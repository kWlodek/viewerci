...
public class Study {
    ...
    private List<hbgm.data.Series> seriesList = new ArrayList<hbgm.data.Series>();
    ...
    public hbgm.data.Series add(hbgm.data.Series ser) {
        // TODO implement:
        /*
        ...
        a reference to it.
         */
        for (hbgm.data.Series s : seriesList) {
